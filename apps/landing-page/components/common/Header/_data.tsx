    ...
    children: [
      {
        ...
        href: 'https://github.com/botaas',
        icon: <GitHubIcon fill="blue.300" />,
      },
      {
        label: 'Documentation',
        description:
          "Everything you need to know about how to use Openbot's builder",
        href: 'https://docs.openbot.chat',
        icon: <DocIcon />,
      },
      {
        label: 'Roadmap',
        ...
        href: 'https://feedback.openbot.chat/roadmap',
        icon: <MapIcon />,
      },
      {
        label: 'Community',
