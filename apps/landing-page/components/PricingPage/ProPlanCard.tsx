  ...
  return (
    ...
    independant of the number of messages he sends and receives."
      ...
      button={
        <Button
          as={Link}
          // href={`https://dashboard.openbot.chat/auth/signup?subscribePlan=${PlanEnum.PRO}&chats=${selectedChatsLimitIndex}&storage=${selectedStorageLimitIndex}`}
          href="/auth/signup"
          colorScheme="blue"
          size="lg"
          w="full"
