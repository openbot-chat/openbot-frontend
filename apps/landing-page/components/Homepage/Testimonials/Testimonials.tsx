...
const testimonials: TestimonialData[][] = [
  [
    {
      ...
      provider: 'email',
      content:
        'I upgraded my typeforms to openbots and saw a conversion rate increase from 14% to 43% on my marketing campaigns. I noticed the improvement on day one. That was a game-changer.',
    },
    {
      name: 'Laszlo Csömör',
    ...
    },
    {
      ...
      content: (
        <>
          Thanks to openbot I can finally make site forms much more modern and I
  ...
  [
    ...
    },
    {
      ...
      content: (
        <>
          Amazing product! I&apos;m using Openbot for everything when it&apos;s
          about talking with customers.
          <br />
          <br />
          What&apos;s amazing with Openbot is that it makes a &quot;chat
  ...
  [
    ...
    },
    {
      ...
      content: (
        <>
          I used Openbot at my company and was impressed with how it cut our
    ...
    },
    {
      ...
      provider: 'email',
      content:
        'I am really loving using Openbot! So good. I have used all the top bots and yours is definitely the most user friendly, and yet still so powerful.',
    },
    {
      name: 'Anna Filou',
      provider: 'productHunt',
