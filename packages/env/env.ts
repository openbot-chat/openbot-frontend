...
const baseEnv = {
  ...
  client: {
    ...
    NEXT_PUBLIC_OPENBOT_WEB_API_BASE_URL: z.string().url().optional(),
  },
  runtimeEnv: {
    ...
    NEXT_PUBLIC_VIEWER_INTERNAL_URL: getRuntimeVariable('NEXT_PUBLIC_VIEWER_INTERNAL_URL'),
    NEXT_PUBLIC_OPENBOT_WEB_API_BASE_URL: getRuntimeVariable('NEXT_PUBLIC_OPENBOT_WEB_API_BASE_URL'),
  },
}
const githubEnv = {
  server: {
